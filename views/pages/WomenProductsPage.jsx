...
//     {
//       id: 1,
//       name: 'TSS Originals: Panchatantra Women Holiday Shirts',
//       price: '₹1299',
//       image: 'https://via.placeholder.com/300x400?text=Product+1', // Replace with actual image URL
//     },
//     {
//       id: 2,
//       name: 'Gilmore Girls: The Bond Women Holiday Shirts',
//       price: '₹1299',
//       image: 'https://via.placeholder.com/300x400?text=Product+2', // Replace with actual image URL
//     },
//     {
//       id: 3,
//       name: 'TSS Originals: Birds Women Holiday Shirts',
//       price: '₹1499',
//       image: 'https://via.placeholder.com/300x400?text=Product+3', // Replace with actual image URL
//     },
//     {
//       id: 4,
//       name: 'Cotton Linen: Butterfly Women Shirts',
//       price: '₹1899',
//       image: 'https://via.placeholder.com/300x400?text=Product+4', // Replace with actual image URL
//     },
//     {
//       id: 5,
//       name: 'Oversized Fit',
//       price: '',
//       image: 'https://via.placeholder.com/300x400?text=Product+5', // Replace with actual image URL
//     },
//     {
//       id: 6,
//       name: 'Oversized Fit',
//       price: '',
//       image: 'https://via.placeholder.com/300x400?text=Product+6', // Replace with actual image URL
//     },
//     {
//       id: 7,
//       name: 'Did You Know? MEMBERS GET EXTRA DISCOUNTS',
//       price: '',
//       image: 'https://via.placeholder.com/300x400?text=Promo', // Replace with actual image URL
//     },
//     {
//       id: 8,
//       name: 'Oversized Fit',
//       price: '',
//       image: 'https://via.placeholder.com/300x400?text=Product+8', // Replace with actual image URL
//     },
//   ];
...
//         >
//           <div>
//             <a href="#" style={{ color: '#ff0000', fontSize: '14px' }}>
//               SUMMER COLLECTION 🔥
//             </a>
//             <span style={{ color: '#000', margin: '0 10px' }}>|</span>
//             <a href="#" style={{ color: '#000', fontSize: '14px' }}>
//               Women’s Shirts - 28 Items
//             </a>
//           </div>
//           <div>
//             <a href="#" style={{ color: '#000', fontSize: '14px', margin: '0 10px' }}>
//               Topwear
//             </a>
//             <a href="#" style={{ color: '#000', fontSize: '14px', margin: '0 10px' }}>
//               Bottomwear
...
//           </div>
//           <div>
//             <span style={{ fontSize: '14px' }}>Select Sorting Options</span>
//           </div>
//         </div>
...
//               <li>
//                 <input type="checkbox" /> Unisex Shirts
//               </li>
//               <li>
//                 <input type="checkbox" /> Women Boxy Fit Shirts
//               </li>
//               <li>
//                 <input type="checkbox" /> Women Boyfriend Shirts
//               </li>
//               <li>
//                 <input type="checkbox" /> Women Cropped Shirts
//               </li>
//               <li>
//                 <input type="checkbox" /> Women Denim Jackets
//               </li>
//               <li>
//                 <input type="checkbox" /> Women Holiday Shirts
//               </li>
//               <li>
//                 <input type="checkbox" /> Women Jackets
//               </li>
//               <li>
//                 <input type="checkbox" /> Women Oversized Cropped Shirts
//               </li>
//               <li>+ 2 more</li>
//             </ul>
//             <h3 style={{ fontSize: '16px', fontWeight: 'bold', marginTop: '20px', marginBottom: '10px' }}>
//               SIZE
//             </h3>
//             <input
//               type="text"
...
//             />
//             <div>
//               <button style={{ padding: '5px 10px', margin: '5px' }}>XXS</button>
//               <button style={{ padding: '5px 10px', margin: '5px' }}>XS</button>
//               <button style={{ padding: '5px 10px', margin: '5px' }}>S</button>
//               <button style={{ padding: '5px 10px', margin: '5px' }}>M</button>
//               <button style={{ padding: '5px 10px', margin: '5px' }}>L</button>
//               <button style={{ padding: '5px 10px', margin: '5px' }}>XL</button>
//               <button style={{ padding: '5px 10px', margin: '5px' }}>XXL</button>
//             </div>
//             <h3 style={{ fontSize: '16px', fontWeight: 'bold', marginTop: '20px', marginBottom: '10px' }}>
//               PRICES
//             </h3>
//             <input type="checkbox" /> ₹799 - ₹1298
//             <br />
//             <input type="checkbox" /> ₹1299 - ₹1798
//           </div>
...
//                   {product.name}
//                 </h4>
//                 <p style={{ fontSize: '16px', color: '#000', fontFamily: "'Lora', serif" }}>
//                   {product.price}
//                 </p>
//               </div>
//             ))}
...
//       price: '$15.59',
//       image: 'https://i.pinimg.com/736x/cf/47/e8/cf47e82156b8c5fe50531f7994de9ecd.jpg', // Replace with actual image URL
//     },
//     {
//       id: 2,
//       name: 'Autumn Bond: Soft Knit Casual Top',
//       price: '$15.59',
//       image: 'https://i.pinimg.com/474x/08/39/8f/08398f93503a05b5e3c993750ea32f43.jpg', // Replace with actual image URL
//     },
//     {
//       id: 3,
//       name: 'Wings & Whimsy: Bird Print Flowy Top',
//       price: '$17.99',
//       image: 'https://i.pinimg.com/474x/7e/9d/81/7e9d8176dc6ed5f186198d940665b6cd.jpg', // Replace with actual image URL
//     },
//     {
//       id: 4,
//       name: 'Butterfly Whisper: Linen Blend Relaxed Top',
//       price: '$18.99',
//       image: 'https://i.pinimg.com/474x/b5/33/7c/b5337c6933bac8d55cea05fb7cedb9c4.jpg', // Replace with actual image URL
//     },
//     {
//         id: 5,
...
//         >
//           <img
//             src="https://img.freepik.com/premium-photo/fashion-trend-portrait-young-woman-bathroom-setting-sun-illuminates-beautiful-female-model-modern-island-home_121946-5088.jpg?w=1060" // Replace with actual wide hero image URL
//             alt="Hero Banner"
//             style={{
//               width: '100%',
//               height: '500px',
...
//                 fontFamily: "'Playfair Display', serif",
//                 textShadow: '2px 2px 8px rgba(0, 0, 0, 0.5)',
//                 color: '#8B4513', // Brown color to match the image
//               }}
//             >
//               Story
//             </h1>
...
//         {/* Navigation and Product Section */}
//         <div
//           style={{
//             display: 'flex',
//             justifyContent: 'space-between',
